locals {
  ...
  receipt_queue_name     = var.receipt_queue_name != "" ? var.receipt_queue_name : "fit-receipt-events${local.env_suffix}"
  receipt_dlq_queue_name = var.receipt_dlq_queue_name != "" ? var.receipt_dlq_queue_name : "fit-receipt-events-dlq${local.env_suffix}"
}
