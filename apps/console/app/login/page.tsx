    ...
    <div className="flex min-h-svh w-full" style={{ backgroundColor: "var(--background)", fontFamily: "var(--font-sans, sans-serif)" }}>
        ...
        <div className="lg:max-w-md">
          <div className="mb-10">
            ...
            <Text variant="muted" size="lg">
              Gestiona tu plataforma SaaS desde un solo lugar
            </Text>
          </div>
      ...
      <section className="hidden lg:block w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-16 left-16 z-20 max-w-[360px]">
          ...
          <Title as="h3" size="card" className="mb-3 text-foreground">
            Control Total
          </Title>
          <Text variant="subtle" className="text-foreground-muted font-light leading-relaxed">
            Administración centralizada de todas tus organizaciones y suscripciones SaaS.
          </Text>
        </div>
      </section>
    </div>
