...
> **📜 Documento histórico (ya ejecutado).** Se conserva como registro de la fase. Los estados de pago mencionados (`invalid`, `voided/invalid`) quedaron **unificados en `voided`** (ver `vaults/business/PAYMENT_STATUSES.md`).
