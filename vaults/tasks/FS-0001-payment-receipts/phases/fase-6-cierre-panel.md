...
> **📜 Documento histórico (ya ejecutado).** Los estados de pago se unificaron después (`voided` único; sin `invalid`) — ver `vaults/business/PAYMENT_STATUSES.md`.
