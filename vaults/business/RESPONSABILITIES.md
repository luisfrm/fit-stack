...
- Ser honesto en el documento sobre su naturaleza: es un **comprobante de pago**, no una factura fiscal, salvo que la Org cumpla los tres requisitos de la sección "Cuándo pasar a factura" (ver `[[FACTURATION]]`).
