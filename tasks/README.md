...
|---|---|
| `packages/shared` | `src/documents/` (nuevo: gate, fiscal-profile, tax-math, receipt-number, receipt-data, receipt-events, receipt-storage-keys, receipt-compose), `src/index.ts`, `src/types.ts`, `tests/documents/` |
