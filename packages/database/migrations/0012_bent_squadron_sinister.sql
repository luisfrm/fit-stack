CREATE TABLE "organization_document_sequence" (
	...
	CONSTRAINT "organization_document_sequence_organization_id_document_type_year_pk" PRIMARY KEY("organization_id","document_type","year")
);
...
CREATE INDEX "idx_payment_org_issued_at" ON "payment" USING btree ("organization_id","receipt_issued_at");--> statement-breakpoint
