      ...
      <div className="flex flex-col gap-1.5 w-full h-full">
        ...
        >
          <textarea
            id={textareaId}
            className={cn(
              "flex-1 w-full h-full bg-transparent outline-none border-none shadow-none px-4 py-3 text-base md:text-sm text-foreground placeholder-foreground-dim/50 min-w-0 resize-y",
