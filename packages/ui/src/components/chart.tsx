    ...
    <ChartContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          ...
          // Sinergia: Líneas sutiles y ticks con baja opacidad
          "[&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground/70",
...
function ChartTooltipContent({
  ...
  React.ComponentProps<"div"> & {
    ...
    "accessibilityLayer"
  >) {
  const { config, variant: contextVariant } = useChart()
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 rounded-xl border border-white/10 px-3 py-2 text-xs shadow-2xl",
        variant === "glass" ? "bg-glass backdrop-blur-md" : "bg-surface",
        className
      )}
    >
